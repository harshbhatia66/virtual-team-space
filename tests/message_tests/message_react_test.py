...
'''
--------------------------------------------------------
    Test for Messages React on channels
--------------------------------------------------------
'''
...
def test_already_reacted1(setup1):
    message_react_v1(setup1[2], setup1[0], 1)
    with pytest.raises(InputError):
        assert message_react_v1(setup1[2], setup1[0], 1)
        
# When user tries to react again on a message - DM
def test_already_reacted2(setup2):
    message_react_v1(setup2[2], setup2[0], 1)
    with pytest.raises(InputError):
        assert message_react_v1(setup2[2], setup2[0], 1)