...
from src.message import message_send_v1, message_send_dm_v1, message_pin_v1, message_unpin_v1
...
'''
--------------------------------------------------------
    Test for Messages Unpin on channels
--------------------------------------------------------
'''
...
def test_successful_pin2(setup2):
    message_pin_v1(setup2[1], setup2[0])
    message_unpin_v1(setup2[1], setup2[0])
